    ...
    useEffect(() => {
        ...
        if (typeof window !== "undefined") {
            ...
            if (storedUser) {
                ...
                // Parse tab parameter from URL query string if not logged in
                const tabParam = searchParams.get("tab");
                if (tabParam && ["login", "signup", "forgot", "dashboard"].includes(tabParam)) {
            ...
            {activeTab === "dashboard" && user ? (
                ...
                <div className="w-full max-w-md relative z-10 animate-fade-in">
                    ...
                    <div className="bg-white/70 dark:bg-zinc-900/35 border border-zinc-200 dark:border-zinc-900/80 backdrop-blur-md p-8 rounded-3xl shadow-xl dark:shadow-none">
                        ...
                        {/* ==================== SIGNUP FORM (podmod Screenshot Styled) ==================== */}
                        {activeTab === "signup" && (
                            <div className="bg-white border border-zinc-200 shadow-xl rounded-2xl overflow-hidden mt-2 text-zinc-900">
                                {/* Grey Header Panel */}
                                <div className="bg-zinc-50 border-b border-zinc-200 px-5 py-4 flex items-center gap-3">
                                    <div className="p-2 bg-zinc-200 text-zinc-700 rounded-lg">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                        </svg>
                                    </div>
                                    <span className="text-xs font-black text-zinc-800 uppercase tracking-widest">Your information</span>
                                </div>

                                <form onSubmit={handleSignup} className="p-6 space-y-5">
                                    {/* Name Row: Name & Last Name (50% / 50%) */}
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5 flex flex-col items-start">
                                            <label className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider">Your name <span className="text-rose-500">*</span></label>
                                            <input
                                                type="text"
                                                required
                                                placeholder="First name"
                                                className="w-full bg-zinc-50 border border-zinc-200 rounded-lg px-3 py-2.5 text-xs text-zinc-900 focus:outline-none focus:border-zinc-950 focus:ring-1 focus:ring-zinc-950 transition-all font-medium"
                                                // We map this local value directly to the existing name state
                                                onChange={(e) => {
                                        ...
                                        <div className="space-y-1.5 flex flex-col items-start">
                                            <label className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider">Your last name <span className="text-rose-500">*</span></label>
                                            <input
                                                type="text"
                                                required
                                    ...
                                    {/* Email Row (100%) */}
                                    <div className="space-y-1.5 flex flex-col items-start">
                                        <label className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider">Email <span className="text-rose-500">*</span></label>
                                        <input
                                            type="email"
                                            required
                                            value={email}
                                    ...
                                    {/* Password Row: Password & Repeat Password (50% / 50%) */}
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5 flex flex-col items-start">
                                            <label className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider">Password <span className="text-rose-500">*</span></label>
                                            <input
                                                type="password"
                                                required
                                                value={password}
                                        ...
                                        <div className="space-y-1.5 flex flex-col items-start">
                                            <label className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider">Repeat Password <span className="text-rose-500">*</span></label>
                                            <input
                                                type="password"
                                                required
                                    ...
                                    {password && (
                                        <div className="space-y-1.5 pt-1.5 animate-fade-in text-left">
                                    ...
                                    {/* Grey Slate Heavy Submit Button with Floppy Disk */}
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="w-full py-3.5 px-4 bg-zinc-800 hover:bg-zinc-900 text-white font-extrabold text-xs uppercase tracking-widest rounded-lg shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer border-none disabled:opacity-50"
                                    >
                                        {loading ? (
                                            <svg className="w-4 h-4 animate-spin text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 1121.21 7.89" />
                                            ...
                                            <svg className="w-4 h-4 text-white shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4H9m0 0l3 3m-3-3l3-3M12 3v4" />
                                            </svg>
                                        )}
